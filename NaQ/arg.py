...
def parse_args(setting):
    ...
    if setting == 'sup':
        # sup: 학습과 평가에서 사용하는 데이터 구조나 처리 방식이 동일하다. 
        ...
        # unsup: 학습과 평가의 목적과 데이터 사용 방식이 다르다. 
    ...
    argparser.add_argument('--num_downstream_tasks', type=int, default=500, help='# of downstream tasks to evaluate. 500 used.') # for test
    argparser.add_argument('--num_valid_tasks', type=int, default=50, help='# of validation tasks to evaluate. 50 used.') # for validation
